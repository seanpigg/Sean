...
def _chromium_ok():
    """Playwright installed AND a browser actually downloaded."""
    try:
...
def pdf_engine_status():
    ...
    if chrome_ok:
        return {
            "ok": True,
            "engine": "chromium",
            "note": "The redesigned PDF is in use, rendered by Chromium.",
        }
        ...
        with sync_playwright() as pw:
            ...
            try:
                ...
                pdf = page.pdf(
                    ...
                    margin={"top": "0.92in", "right": "0.5in",
                            "bottom": "0.85in", "left": "0.5in"},
                    display_header_footer=True,
                    header_template="<div></div>",
                    # Chromium does not support @page margin boxes, so the page
                    # counter lives here instead of in the stylesheet.
                    footer_template=(
                        "<div style=\"width:100%;padding:0 0.5in;"
                        "font-family:'IBM Plex Mono',monospace;font-size:6.5pt;"
                        "font-weight:600;color:#7488A0;text-align:right;\">"
